...
-- Dump completed on 2024-05-15 21:57:49
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
...
INSERT INTO `endereço` VALUES (1,1,'Santa_Rita'),(2,2,'terrao'),(3,3,'morro'),(4,4,'favela'),(5,5,'nobresa');
...
LOCK TABLES `usuario` WRITE;
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` VALUES (1,'Mauro',29),(2,'Guilherme',41),(3,'Gustavo',54),(4,'ze',80),(5,'flavio',32);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
